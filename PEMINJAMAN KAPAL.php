    ...
    <nav class="teal">
      <div class="container">
        <div class="nav-wrapper">
          <a href="#" class="brand-logo">PENYEWAAN KAPAL</a>
    ...
    <form action="post_view.php" method="post">
          <div class="card-panel grey lighten-3">
            ...
            <div class="input-field">
              <input type="text" placeholder="Nama Penyewa" name="nama">
            </div>
            <div class="input-field">
        ...
        <div class="col s12 m6">
          <div class="card-panel grey lighten-3">
            <h5>DATA KAPAL</h5>
            <div class="input-field">
              <input type="text" placeholder="Jenis kapal" name="jenis_kapal">
            </div>
            <div class="input-field">
            ...
            <div class="input-field">
            <input type="date" placeholder="Tanggal Peminjaman" name="tanggal">
            </div>
